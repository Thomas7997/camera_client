...
Fichiers * new_fichiers_list (void) {
    ...
    fichiers->nom = (char*) malloc(100 * sizeof(char));
    fichiers->nom = "";
    fichiers->type = (char*) malloc(100 * sizeof(char));
    fichiers->type = "";
...
Dossiers * new_dossiers_list (void) {
    ...
    dossiers->nom = (char*) malloc(100 * sizeof(char));
    dossiers->nom = "";
    dossiers->fils = (Dossiers*) malloc(sizeof(Dossiers));
    dossiers->fils->nom = (char*) malloc(100 * sizeof(char));
    dossiers->fils->nom = "";
